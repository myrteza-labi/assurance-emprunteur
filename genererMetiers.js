...
let myData = require('./metiers.json');
...
for (var i = 0; i < myDataLenght; i++) {
  ...
  'import Metiers from "../metiers.json"; import Head from "next/head" ; export default function '+nomComposantFinal +'() { let test = Metiers.map((metier) => { return metier["data"]['+iToString+']["contenu"];});return <div><Head> <meta name="description" content="'+descriptionToString+'"/> </Head><div className=" pageGenerees pageMetier" dangerouslySetInnerHTML={{ __html: test }}></div></div>;}';
